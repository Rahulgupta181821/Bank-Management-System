...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree( String formno){
        ...
        c7 = new JCheckBox("I Hereby declare that the abve entered details are correct to the best of my knowledge.");
        c7.setBackground(Color.white);
        c7.setFont(new Font("Raleway",Font.BOLD,12));
        c7.setBounds(100, 690 , 550, 30);
        add(c7);
        ...
        if(ae.getSource()== submit){
           ...
           try {
            ...
            if(accountType.equals("")){
                JOptionPane.showMessageDialog(null, "Accounts Type is Required");
            }else{
                Conn conn = new Conn();
